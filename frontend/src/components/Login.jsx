    ...
    <div className='min-w-96 mx-auto'>
      <div className='w-full p-6 rounded-lg shadow-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-10 border border-gray-100'>
        ...
        <form onSubmit={onSubmitHandler} action="">
          ...
          <p className='text-center my-2'>Don't have an account? <Link to="/signup"> Sign Up </Link></p>

          <div>
            <button type='submit' className='btn btn-block btn-sm mt-2 border border-slate-400 bg-blue-500'>Login</button>
          </div>
